...
get index do
    top_series_list = []
    gameOfT_url = "http://www.omdbapi.com/?apikey=2f6435d9&t=Game of Thrones"
    @gameOfT_series = HTTParty.get(gameOfT_url).parsed_response
    friends_url = "http://www.omdbapi.com/?apikey=2f6435d9&t=Friends"
    @friends_series = HTTParty.get(friends_url).parsed_response
    better_call_saul_url ="http://www.omdbapi.com/?apikey=2f6435d9&t=Better Call Saul"
    @better_call_saul_series = HTTParty.get(better_call_saul_url).parsed_response
    sherlock_url = "http://www.omdbapi.com/?apikey=2f6435d9&t=Sherlock"
    @sherlock_series = HTTParty.get(sherlock_url).parsed_response
    peaky_blinders_url = "http://www.omdbapi.com/?apikey=2f6435d9&t=Peaky Blinders"
    @peaky_blinders_series = HTTParty.get(peaky_blinders_url).parsed_response
    erb :index
end
